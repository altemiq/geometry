// -----------------------------------------------------------------------
// <copyright file="MapCustomSymbol.cs" company="Altemiq">
...
/// <summary>
/// The <see cref="MapInfo"/> <see cref="Altemiq.Geometry.Point"/> with a custom symbol.
/// </summary>
/// <param name="X">The x-coordinate.</param>
/// <param name="Y">The y-coordinate.</param>
/// <param name="CustomStyleId">The custom style ID.</param>
/// <param name="FontId">The font ID.</param>
[System.Runtime.InteropServices.StructLayout(System.Runtime.InteropServices.LayoutKind.Sequential)]
public readonly record struct MapCustomSymbol(double X, double Y, byte CustomStyleId, byte FontId) : Altemiq.Geometry.IGeometry
{
    /// <summary>
    /// Gets the point.
    /// </summary>
