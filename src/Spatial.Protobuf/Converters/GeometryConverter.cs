...
public static class GeometryConverter
{
    ...
    /// <exception cref="Geometry.InvalidGeometryTypeException">The geometry type was incorrect.</exception>
    public static TGeometry Parse<TGeometry>(GeometryData geometryData)
    {
        ...
        static TGeometry ParseWkt(string wkt)
        {
            ...
            return Buffers.Text.WktParser.TryParse(span, out Geometry.IGeometry? geometry, out _) && geometry is TGeometry geometryObject
                ? geometryObject
