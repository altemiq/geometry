    ...
    public static bool TryParse(ReadOnlySpan<byte> source, [System.Diagnostics.CodeAnalysis.NotNullWhen(true)] out Geometry.IGeometry? value, out int bytesConsumed)
    {
        if (TryGetTypeAndDimensions(source, out var result, out var parser))
        {
            value = result switch
            {
                ...
                (GeometryType.MultiLineString, false, false, 2) => new Geometry.MultiGeometry<Geometry.Polyline>([.. GetMultiLineString(2, ref parser, GetPoint, GetLineString)]),
                (GeometryType.MultiLineString, true, false, 3) => new Geometry.MultiGeometryZ<Geometry.PolylineZ>([.. GetMultiLineString(3, ref parser, GetPointZ, GetLineStringZ)]),
                (GeometryType.MultiLineString, false, true, 3) => new Geometry.MultiGeometryM<Geometry.PolylineM>([.. GetMultiLineString(3, ref parser, GetPointM, GetLineStringM)]),
                (GeometryType.MultiLineString, true, true, 4) => new Geometry.MultiGeometryZM<Geometry.PolylineZM>([.. GetMultiLineString(4, ref parser, GetPointZM, GetLineStringZM)]),
                (GeometryType.MultiPolygon, false, false, 2) => new Geometry.MultiGeometry<Geometry.Polygon>([.. GetMultiPolygon(2, ref parser, GetPoint, GetPolygon)]),
                (GeometryType.MultiPolygon, true, false, 3) => new Geometry.MultiGeometryZ<Geometry.PolygonZ>([.. GetMultiPolygon(3, ref parser, GetPointZ, GetPolygonZ)]),
                (GeometryType.MultiPolygon, false, true, 3) => new Geometry.MultiGeometryM<Geometry.PolygonM>([.. GetMultiPolygon(3, ref parser, GetPointM, GetPolygonM)]),
                (GeometryType.MultiPolygon, true, true, 4) => new Geometry.MultiGeometryZM<Geometry.PolygonZM>([.. GetMultiPolygon(4, ref parser, GetPointZM, GetPolygonZM)]),
