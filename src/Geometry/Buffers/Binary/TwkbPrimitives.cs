...
public static class TwkbPrimitives
{
    ...
    private static Geometry.IGeometry ReadGeometry(ReadOnlySpan<byte> source, TinyWkbRecordHeader header, out IList<long>? idList)
    {
        ...
        return (header.GeometryType, header.HasZ, header.HasM) switch
        {
            ...
            (TinyWkbGeometryType.MultiPoint, false, false) => new Geometry.MultiGeometry<Geometry.Point>(internalReader.ReadPoints(out idList, header.HasIdList, CreatePoint)),
            (TinyWkbGeometryType.MultiPoint, true, false) => new Geometry.MultiGeometryZ<Geometry.PointZ>(internalReader.ReadPoints(out idList, header.HasIdList, CreatePointZ)),
            (TinyWkbGeometryType.MultiPoint, false, true) => new Geometry.MultiGeometryM<Geometry.PointM>(internalReader.ReadPoints(out idList, header.HasIdList, CreatePointM)),
            (TinyWkbGeometryType.MultiPoint, true, true) => new Geometry.MultiGeometryZM<Geometry.PointZM>(internalReader.ReadPoints(out idList, header.HasIdList, CreatePointZM)),
            ...
            (TinyWkbGeometryType.MultiLinestring, false, false) => new Geometry.MultiGeometry<Geometry.Polyline>([.. ReadMultiLineStringCore(internalReader, header.HasIdList, CreatePoint).Select(p => new Geometry.Polyline(p))]),
            (TinyWkbGeometryType.MultiLinestring, true, false) => new Geometry.MultiGeometryZ<Geometry.PolylineZ>([.. ReadMultiLineStringCore(internalReader, header.HasIdList, CreatePointZ).Select(p => new Geometry.PolylineZ(p))]),
            (TinyWkbGeometryType.MultiLinestring, false, true) => new Geometry.MultiGeometryM<Geometry.PolylineM>([.. ReadMultiLineStringCore(internalReader, header.HasIdList, CreatePointM).Select(p => new Geometry.PolylineM(p))]),
            (TinyWkbGeometryType.MultiLinestring, true, true) => new Geometry.MultiGeometryZM<Geometry.PolylineZM>([.. ReadMultiLineStringCore(internalReader, header.HasIdList, CreatePointZM).Select(p => new Geometry.PolylineZM(p))]),
            ...
            (TinyWkbGeometryType.MultiPolygon, false, false) => new Geometry.MultiGeometry<Geometry.Polygon>([.. ReadMultiPolygonCore(internalReader, header.HasIdList, CreatePoint).Select(p => new Geometry.Polygon(p))]),
            (TinyWkbGeometryType.MultiPolygon, true, false) => new Geometry.MultiGeometryZ<Geometry.PolygonZ>([.. ReadMultiPolygonCore(internalReader, header.HasIdList, CreatePointZ).Select(p => new Geometry.PolygonZ(p))]),
            (TinyWkbGeometryType.MultiPolygon, false, true) => new Geometry.MultiGeometryM<Geometry.PolygonM>([.. ReadMultiPolygonCore(internalReader, header.HasIdList, CreatePointM).Select(p => new Geometry.PolygonM(p))]),
            (TinyWkbGeometryType.MultiPolygon, true, true) => new Geometry.MultiGeometryZM<Geometry.PolygonZM>([.. ReadMultiPolygonCore(internalReader, header.HasIdList, CreatePointZM).Select(p => new Geometry.PolygonZM(p))]),
