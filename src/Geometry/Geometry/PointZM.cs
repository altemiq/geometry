...
public readonly struct PointZM :
    ...
    System.Numerics.ISubtractionOperators<PointZM, SizeZ, PointZM>,
    ...
    IEquatable<PointZM>
{
    ...
    /// <inheritdoc/>
    public override int GetHashCode() => HashCode.Combine(this.X, this.Y, this.Z, this.Measurement);
    ...
    public string ToString(IFormatProvider? formatProvider) => ((FormattableString)$"{{X={this.X}, Y={this.Y}, Z={this.Z}, Measurement={this.Measurement}}}").ToString(formatProvider);
