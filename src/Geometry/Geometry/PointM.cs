    ...
    IEquatable<PointM>
{
    ...
    /// <inheritdoc/>
    public override int GetHashCode() => HashCode.Combine(this.X, this.Y, this.Measurement);
    ...
    public string ToString(IFormatProvider? formatProvider) => ((FormattableString)$"{{X={this.X}, Y={this.Y}, Z={this.Measurement}}}").ToString(formatProvider);
