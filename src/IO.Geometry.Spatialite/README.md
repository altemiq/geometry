...
A complete SpatiaLite I/O package that includes native SQLite and SpatiaLite binaries. This is a wrapper package that depends on `Altemiq.IO.Geometry.Spatialite.Core`.
...
```csharp
using Altemiq.IO.Geometry.Spatialite;
...
- [Altemiq.IO.Geometry.Spatialite.Core](https://www.nuget.org/packages/Altemiq.IO.Geometry.Spatialite/) - Core SpatiaLite I/O
