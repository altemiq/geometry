...
public class GaiaWriterTests
{
    ...
    public async Task WritePoint()
    {
        ...
        var written = Buffers.Binary.GaiaPrimitives.WritePointLittleEndian(bytes, point, 0);

        _ = await Assert.That(written).IsEquivalentTo(expected.Length);
    ...
    public async Task WritePointZ()
    {
        ...
        var written = Buffers.Binary.GaiaPrimitives.WritePointZLittleEndian(bytes, point, 0);
    ...
    public async Task WritePointZM()
    {
        ...
        var written = Buffers.Binary.GaiaPrimitives.WritePointZMLittleEndian(bytes, point, 0);
    ...
    public async Task WriteLineString()
    {
        ...
        var written = Buffers.Binary.GaiaPrimitives.WriteLineStringLittleEndian(bytes, lineString, 0);
    ...
    public async Task WriteLineStringZ()
    {
        ...
        var written = Buffers.Binary.GaiaPrimitives.WriteLineStringZLittleEndian(bytes, lineString, 0);
    ...
    public async Task WriteLineStringZM()
    {
        ...
        var written = Buffers.Binary.GaiaPrimitives.WriteLineStringZMLittleEndian(bytes, lineString, 0);
    ...
    public async Task WritePolygonSimple()
    {
        ...
        var written = Buffers.Binary.GaiaPrimitives.WritePolygonLittleEndian(bytes, polygon, 0);
    ...
    public async Task WriteMultiPoint()
    {
        ...
        var written = Buffers.Binary.GaiaPrimitives.WritePointLittleEndian(bytes, points, 0);
    ...
    public async Task WriteMultiLineString()
    {
        ...
        var written = Buffers.Binary.GaiaPrimitives.WriteLineStringLittleEndian(bytes, lines, 0);
    ...
    public async Task WriteMultiPolygonSimple()
    {
        ...
        var written = Buffers.Binary.GaiaPrimitives.WritePolygonLittleEndian(bytes, polygons, 0);
