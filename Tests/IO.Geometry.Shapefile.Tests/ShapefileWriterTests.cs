...
public class ShapefileWriterTests
{
    ...
    public async Task WriteMultiPoint()
    {
        ...
        using (var writer = new ShapefileWriter(
            ...
            ShpType.MultiPoint,
        true,
            Data.Dbf.DbfColumn.Number("AREA", 12, 3),
            Data.Dbf.DbfColumn.Number("PERIMETER", 12, 3),
            Data.Dbf.DbfColumn.Number("EAS_", 11, 0),
            Data.Dbf.DbfColumn.Number("EAS_ID", 11, 0),
            Data.Dbf.DbfColumn.String("ATLAS_P", 16),
            Data.Dbf.DbfColumn.String("ATLAS_S", 16),
            Data.Dbf.DbfColumn.Number("EDLOW", 3, 0),
            Data.Dbf.DbfColumn.Number("EDMED", 3, 0),
            Data.Dbf.DbfColumn.Number("EDHIGH", 3, 0),
            Data.Dbf.DbfColumn.Number("HHNUMBER", 3, 0),
            Data.Dbf.DbfColumn.Number("AVGHHINC", 6, 0),
            Data.Dbf.DbfColumn.Number("EDUC", 1, 0),
            Data.Dbf.DbfColumn.Number("POTENT", 7, 0),
            Data.Dbf.DbfColumn.Number("ELAT", 8, 5),
            Data.Dbf.DbfColumn.Number("ELON", 8, 4),
            Data.Dbf.DbfColumn.Number("DIS58", 19, 17),
            Data.Dbf.DbfColumn.Number("DIS130", 19, 17),
            Data.Dbf.DbfColumn.Number("DIS208", 19, 17),
            Data.Dbf.DbfColumn.Number("DIS425", 19, 17),
            Data.Dbf.DbfColumn.Number("MKTSHR58", 20, 18),
            Data.Dbf.DbfColumn.Number("MKTSHR130", 20, 18),
            Data.Dbf.DbfColumn.Number("MKTSHR208", 20, 18),
            Data.Dbf.DbfColumn.Number("MKTSHR425", 20, 18),
            Data.Dbf.DbfColumn.Number("LIFESTYLES", 1, 0),
            Data.Dbf.DbfColumn.Number("CUMMKTSHR", 19, 17),
            Data.Dbf.DbfColumn.Number("PENTRA", 7, 0),
            Data.Dbf.DbfColumn.Number("OPPT", 7, 0),
