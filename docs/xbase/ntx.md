...
See [NDX example](ndx_example.md)

1. Also called signature. Distance between key pages. size + 2 longs. i.e. Left pointer + record no.

2. The first, or root page of an index has a minimum of 1 entry regardless of this value.
...
10. ?? This is a reference to the first page in a linked list of empty pages in between valid data.

11. Offset of next unused pages. Address 00 00 00 00h is the last empty page in chain.

12. Binary version no
