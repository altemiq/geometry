// -----------------------------------------------------------------------
// <copyright file="Polyline{T}.cs" company="Altemiq">
...
/// <summary>
/// Represents a collection of points representing a polyline.
/// </summary>
/// <typeparam name="T">The type of point.</typeparam>
public abstract class Polyline<T> : IGeometry, IList<T>, IReadOnlyList<T>, System.Collections.IList
{
    private readonly IList<T> points;

    /// <summary>
    /// Initialises a new instance of the <see cref="Polyline{T}"/> class.
    /// </summary>
    protected Polyline() => this.points = [];

    /// <summary>
    /// Initialises a new instance of the <see cref="Polyline{T}"/> class.
    /// </summary>
    /// <param name="points">The points.</param>
    protected Polyline(IEnumerable<T> points) => this.points = [.. points];
