...
public interface IGeometryRecord
{
    ...
    IMultiGeometry<Point> GetMultiPoint();
    ...
    IMultiGeometry<PointZ> GetMultiPointZ();
    ...
    IMultiGeometry<PointM> GetMultiPointM();
    ...
    IMultiGeometry<PointZM> GetMultiPointZM();
    ...
    IMultiGeometry<Polyline> GetMultiLineString();
    ...
    IMultiGeometry<PolylineZ> GetMultiLineStringZ();
    ...
    IMultiGeometry<PolylineM> GetMultiLineStringM();
    ...
    IMultiGeometry<PolylineZM> GetMultiLineStringZM();
    ...
    IMultiGeometry<Polygon> GetMultiPolygon();
    ...
    IMultiGeometry<PolygonZ> GetMultiPolygonZ();
    ...
    IMultiGeometry<PolygonM> GetMultiPolygonM();
    ...
    IMultiGeometry<PolygonZM> GetMultiPolygonZM();
